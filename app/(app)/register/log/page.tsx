...
export default async function RegisterLogPickCatPage() {
    ...
    <div className="flex flex-col">
      <nav className="flex items-center gap-2 h-14 px-4 bg-card border-b border-border">
        ...
        >
          ...
          <span className="font-semibold">Refeição / Intercorrência</span>
        </Link>
      </nav>
